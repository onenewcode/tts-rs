...
const ENGINE_COMPONENTS: &[ComponentSpec] = &[
    ComponentSpec {
        ...
        functional: FunctionalContract {
            input: "SessionSeed",
            output: "CodecTokenTensor",
            description: "Decode a compiled session seed into codec-token tensors ready for waveform decode.",
        },
        ...
        execution_boundary: ExecutionBoundaryContract {
            accepts: "SessionSeed",
            executes_on: "TalkerGenerator",
            produces: "CodecTokenTensor",
        },
    },
    ComponentSpec {
        ...
        label: "audio_decoder",
        functional: FunctionalContract {
            input: "CodecTokenTensor",
            output: "Waveform",
            description: "Decode finalized codec-token tensors into waveform tensors.",
        },
        resource_contract: ResourceContract {
            workspace: "fixed_capacity",
            session_model: "single_request",
...
pub(crate) const fn qwen_engine_spec() -> EngineSpec {
    EngineSpec {
        ...
        facts: EngineFacts {
            ...
            dag_edges: [("acoustic_generator", "audio_decoder", "CodecTokenTensor")],
            protocols: ["SessionSeed", "CodecTokenTensor", "Waveform"],
        },
